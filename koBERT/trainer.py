...
from koBERT.utils import calc_accuracy
from koBERT.model.model import koBERTClassifier
from kobert_tokenizer import KoBERTTokenizer
from preprocessing.preprocess import data_preprocess, data_split
...
def train(config):
    ...
    full_data, __ = data_preprocess("../data/sentimental.shuf.tsv")
    train_data, valid_data = data_split(full_data)
